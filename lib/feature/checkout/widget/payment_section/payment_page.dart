              ...
              if (checkoutController.othersPaymentList.isNotEmpty)
                Padding(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(
                        child: Text('click_one_of_the_option_bellow'.tr,
                ...
                SizedBox(
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return checkoutController.othersPaymentList
                          .elementAt(index);
                    },
                    shrinkWrap: true,
              ...
              if (checkoutController.digitalPaymentList.isNotEmpty)
                Padding(
                  ...
                  child: DigitalPaymentMethodView(
                    ...
                    onTap: (index) => checkoutController.changePaymentMethod(
                        digitalMethod:
              ...
              child: Column(
                  ...
                  children: [
                              ...
                              isOffline
                                  ...
                                  : ClipRRect(
                                      ...
                                      child: CustomImage(
                                        ...
                                        fit: BoxFit.contain,
                                        image:
                                            '${Get.find<SplashController>().configModel.content?.imageBaseUrl}/payment_modules/gateway_image/${paymentList[index].gatewayImage}',
                                      ),
                                    ),
                              const SizedBox(
                                ...
                                children: checkoutController
                                    ...
                                    .map((offlineMethod) => InkWell(
                                          onTap: () {
                                            ...
                                            bool isPartialPayment = fromPage ==
                                                    "custom-checkout"
                                            ...
                                            checkoutController
                                                .showOfflinePaymentData(
                                                    isShow: false);
                                            showDialog(
                                                context: Get.context!,
                                                builder: (ctx) =>
                                                    OfflinePaymentDialog(
                                                      totalAmount: Get.find<
                                                                      CartController>()
                                                                  .walletPaymentStatus &&
                                                              isPartialPayment
                                                          ? dueAmount
                                                          : totalAmount,
                                                      index: checkoutController
                                                          .offlinePaymentModelList
                                                          .indexOf(
                                                              offlineMethod),
                                                    ));
                    ...
                    (checkoutController.showOfflinePaymentInputData &&
                            isOffline &&
                            isSelected)
                        ? OfflinePaymentInputDataView(
                            customerInfoList: checkoutController
...
class OfflinePaymentInputDataView extends StatelessWidget {
  ...
  const OfflinePaymentInputDataView(
      {super.key, required this.customerInfoList});

  @override
  Widget build(BuildContext context) {
    return Padding(
      padding: const EdgeInsets.only(top: Dimensions.paddingSizeDefault),
      child: customerInfoList != null
          ? Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Padding(
                              ...
                              child: Row(
                                  ...
                                  children: [
                                    ...
                                    const SizedBox(
                                        width: Dimensions.paddingSizeSmall),
                                    Text(
                                        ' :  ${Get.find<CheckOutController>().offlinePaymentInputField[customerInfoList!.indexOf(method)].text}',
                                        style: ubuntuRegular.copyWith(
                                            color: Theme.of(context)
                                                .textTheme
                                                .bodyMedium
