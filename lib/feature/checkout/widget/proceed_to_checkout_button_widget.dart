...
class _ProceedToCheckoutButtonWidgetState
                      ...
                      if (Get.find<CartController>().cartList.isEmpty) {
                        Get.offAllNamed(RouteHelper.getMainRoute('home'));
                          ...
                          (cartController.cartList[0].provider
                                      ?.serviceAvailability ==
                                  0 ||
                              cartController.cartList[0].provider?.isActive ==
                                  0)) {
                        ...
                        if (schedule == null &&
                          ...
                          customSnackBar(
                            ...
                            configModel
                                    .content?.scheduleBookingTimeRestriction ==
                                1 &&
  ...
  _makeDigitalPayment(AddressModel? address,
    ...
    url =
        ...
        '&service_schedule=$schedule&service_address_id=$addressId&callback=$callbackUrl&service_address=$encodedAddress&is_partial=$isPartial&payment_platform=$platform&amountFlag=$amountFlag';
    if (GetPlatform.isWeb) {
