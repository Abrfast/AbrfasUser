...
class _CustomPostCheckoutScreenState extends State<CustomPostCheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    double selectedAmount = Get.find<PaymentController>().selected_amount;
    return WillPopScope(
      onWillPop: () => _exitApp(),
      child: Scaffold(
        endDrawer:
                    ...
                    child: Column(
                      children: [
                        ...
                        (cartController.walletPaymentStatus &&
                                !checkoutController.isPartialPayment)
                            ? const SizedBox()
                            : PaymentPage(
                                addressId: '',
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Row(
                                        ...
                                        children: [
                                          Text(
                                            '${cartController.walletPaymentStatus && isPartialPayment ? "due_amount".tr : "total_price".tr} ',
                        ...
                        SizedBox(
                          height:
                              ResponsiveHelper.isDesktop(context) ? 70 : 110,
                        )
                      ],
                    ),
                  ));
        ...
        bottomSheet:
          ...
          return !ResponsiveHelper.isDesktop(context) &&
                  checkoutController.postDetails != null
              ? GetBuilder<CartController>(builder: (cartController) {
                  bool isPartialPayment = checkoutController.totalAmount >
                      cartController.walletBalance;
                  double totalAmount = checkoutController.totalAmount;
                  double dueAmount = totalAmount -
                      (isPartialPayment ? cartController.walletBalance : 0);
  ...
  void _makePayment(CheckOutController checkoutController,
      ...
      if ((addressModel?.contactPersonName == "null" ||
        ...
        if (checkoutController.selectedOfflineMethod != null &&
          ...
          Response response =
            ...
            isPartial:
                isPartialPayment && cartController.walletPaymentStatus ? 1 : 0,
            customerInfo: base64Url.encode(utf8.encode(
        ...
        if (checkoutController.selectedDigitalPaymentMethod == null &&
          ...
          int amountFlag = Get.find<PaymentController>().getamountFlag;
          ...
          url =
              ...
              '&callback=$callbackUrl&payment_platform=$platform&service_address=$encodedAddress&service_address_id=$addressId&is_partial=$isPartial&service_schedule=$schedule&post_id=${widget.postId}&provider_id=${widget.providerId}&amountFlag=$amountFlag';
